...
local Options = Fluent.Options -- THÃŠM DÃ’NG NÃ€Y
...
-----------------------------------------------------------------------------------------------------------------------------------------------
-- Delay load Ä‘á»ƒ khÃ´ng phÃ¡ GUI
task.delay(3, function()
    ...
    if not success or type(CombatFramework) ~= "table" then
        warn("âŒ KhÃ´ng thá»ƒ load CombatFramework.")
        return
    end
    ...
    if not CbFw2 or not CbFw2.activeController then
        warn("âŒ KhÃ´ng tÃ¬m tháº¥y activeController.")
        return
    end
    ...
    print("âœ… AttackNoCoolDown Ä‘Ã£ sáºµn sÃ ng.")
